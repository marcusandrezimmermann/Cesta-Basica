...
'C:\\Users\\marcu\\Documents\\Tese\\Script\\Bases Ifood\\MG' -> diretorio
...
for(i_arq in 1:length(arquivos)) {
  ...
  rbind(Base_MG, res) -> Base_MG
}

Base_MG2 <- data.frame()

for(i_arq in 221:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG2, res) -> Base_MG2
}
...
Base_MG2 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                localidade = dia, dia = hora, hora = X) -> Base_MG2

Base_MG3 <- data.frame()

for(i_arq in 223:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG3, res) -> Base_MG3
}

Base_MG4 <- data.frame()

for(i_arq in 265:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG4, res) -> Base_MG4
}
...
Base_MG4 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG4


Base_MG5 <- data.frame()

for(i_arq in 266:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG5, res) -> Base_MG5
}
...
Base_MG6 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG6

Base_MG7 <- data.frame()

for(i_arq in 304:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG7, res) -> Base_MG7
}
...
Base_MG8 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG8

Base_MG9 <- data.frame()

for(i_arq in 314:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG9, res) -> Base_MG9
}

Base_MG10 <- data.frame()

for(i_arq in 316:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG10, res) -> Base_MG10
}
...
Base_MG10 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG10


Base_MG11 <- data.frame()

for(i_arq in 317:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG11, res) -> Base_MG11
}

Base_MG12 <- data.frame()

for(i_arq in 329:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG12, res) -> Base_MG12
}
...
Base_MG12 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG12

Base_MG13 <- data.frame()

for(i_arq in 331:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG13, res) -> Base_MG13
}

Base_MG14 <- data.frame()

for(i_arq in 339:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG14, res) -> Base_MG14
}
...
Base_MG14 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG14

Base_MG15 <- data.frame()

for(i_arq in 340:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG15, res) -> Base_MG15
}

Base_MG16 <- data.frame()

for(i_arq in 346:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG16, res) -> Base_MG16
}
...
Base_MG16 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG16

Base_MG17 <- data.frame()

for(i_arq in 347:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG17, res) -> Base_MG17
}

Base_MG18 <- data.frame()

for(i_arq in 348:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG18, res) -> Base_MG18
}
...
Base_MG18 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG18

Base_MG19 <- data.frame()

for(i_arq in 349:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG19, res) -> Base_MG19
}

Base_MG20 <- data.frame()

for(i_arq in 353:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG20, res) -> Base_MG20
}
...
Base_MG20 %>%
  ...
  dplyr::rename(produto_base = nome_produto,
                ...
                preco_produto = nome_estabelecimento, 
                nome_estabelecimento = localidade, 
                localidade = dia, dia = hora, hora = X) -> Base_MG20

Base_MG21 <- data.frame()

for(i_arq in 354:length(arquivos)) {
  res <- read.csv2(arquivos[i_arq])
  rbind(Base_MG21, res) -> Base_MG21
}
...
rbind(Base_MG, Base_MG2) -> Base_total_MG
rbind(Base_total_MG, Base_MG3) -> Base_total_MG
rbind(Base_total_MG, Base_MG4) -> Base_total_MG
rbind(Base_total_MG, Base_MG5) -> Base_total_MG
rbind(Base_total_MG, Base_MG6) -> Base_total_MG
rbind(Base_total_MG, Base_MG7) -> Base_total_MG
rbind(Base_total_MG, Base_MG8) -> Base_total_MG
rbind(Base_total_MG, Base_MG9) -> Base_total_MG
rbind(Base_total_MG, Base_MG10) -> Base_total_MG
rbind(Base_total_MG, Base_MG11) -> Base_total_MG
rbind(Base_total_MG, Base_MG12) -> Base_total_MG
rbind(Base_total_MG, Base_MG13) -> Base_total_MG
rbind(Base_total_MG, Base_MG14) -> Base_total_MG
rbind(Base_total_MG, Base_MG15) -> Base_total_MG
rbind(Base_total_MG, Base_MG16) -> Base_total_MG
rbind(Base_total_MG, Base_MG17) -> Base_total_MG
rbind(Base_total_MG, Base_MG18) -> Base_total_MG
rbind(Base_total_MG, Base_MG19) -> Base_total_MG
rbind(Base_total_MG, Base_MG20) -> Base_total_MG
rbind(Base_total_MG, Base_MG21) -> Base_total_MG

# Ajustando a base sem dados relevantes

Base_total_MG %>%
  dplyr::filter(!(hora == "")) -> Base_total_MG_ajust

# Ajustando os dias do ano para um único padrão: DD/MM/AAAA

unique(Base_total_MG_ajust$dia) -> f
...
Base_total_MG_ajust$dia <- plyr::mapvalues(Base_total_MG_ajust$dia,
                                          from = f,
                                          to = t)
...
SOAR::Store(Base_total_MG_ajust, lib = R_Tese)
...
Base_total_MG_ajust$teste <- apply(sapply(array , grepl, Base_total_MG_ajust$nome_produto), 1, any)
...
Base_total_MG_ajust$preco_produto <- as.numeric(Base_total_MG_ajust$preco_produto)
                                                                        ...
                                                                        ifelse(produto_base == 'Farinha de trigo', preco*1.5,
                                                                               ifelse(produto_base == 'Tomate kg', preco*9,
                                                                                      ifelse(produto_base == 'Café', preco*0.6,
                                                                                             ifelse(produto_base == 'Banana kg', preco_duzia*7.5, preco*6))))))))))) -> Base_MG_reg

# Armazenando a base

SOAR::Store(Base_MG_reg, lib = R_Tese)
...
Base_MG_reg$mes <- as.character(Base_MG_reg$mes)
...
Base_MG_reg %>%
  dplyr::filter(teste == 'FALSE',
                ...
                mes != '202303',
                !(is.na(preco_cesta)),
                preco_cesta != 0) -> Base_MG_reg

Base_MG_reg$produto_base <- plyr::mapvalues(Base_MG_reg$produto_base,
...
DIEESE %>%
  dplyr::filter(UF == 'MG') %>%
  dplyr::select(-UF) %>%
  as.data.frame() -> DIEESE_MG

DIEESE_MG %>%
  dplyr::filter(produto_base == 'Total') %>%
  dplyr::select(-produto_base) -> DIEESE_MG_total

Base_MG_reg %>%
  dplyr::left_join(DIEESE_MG, by = c('produto_base', 'mes')) -> Cesta_BasicaIfood_MG

cv<-function(x){coef<-sd(x)/mean(x)*100 
return(coef)}

Cesta_BasicaIfood_MG %>%
...
# Cesta_BasicaIfood_MG %>%
#   dplyr::group_by(produto_base) %>%
#   dplyr::mutate(teste2 = ifelse(produto_base == 'Carne' & preco_cesta >= median(preco_cesta)*1.2 & preco_cesta <= median(preco_cesta)*5, 'FALSE',
#                                 ifelse(produto_base == 'Banana' & preco_cesta >= median(preco_cesta)*1.1 & preco_cesta <= median(preco_cesta)*14, 'FALSE',
#                                        ifelse(produto_base == 'Batata' & preco_cesta >= median(preco_cesta)*1 & preco_cesta <= median(preco_cesta)*5, 'FALSE',
#                                               ifelse(produto_base == 'Tomate' & preco_cesta >= median(preco_cesta)*3.8 & preco_cesta <= median(preco_cesta)*10, 'FALSE',
#                                                      ifelse(produto_base == 'Pão' & preco_cesta >= median(preco_cesta)*0.1 & preco_cesta <= median(preco_cesta)*1.7, 'FALSE',
...
#   dplyr::left_join(DIEESE_MG_total, by = 'mes') %>%
#   dplyr::mutate(diferenca = (preco_calculado - preco_oficial)/preco_oficial) -> Cesta_Final_MG
...
Cesta_BasicaIfood_MG %>%
  ...
  dplyr:: select(mes, preco_calculado, variancia, desvio_padrao, coef_var,
                 lim_inf, lim_sup, preco_oficial, diferenca) -> Cesta_Final_MG

openxlsx::write.xlsx(Cesta_Final_MG, file='Cesta_BasicaIfood_MG.xlsx')
